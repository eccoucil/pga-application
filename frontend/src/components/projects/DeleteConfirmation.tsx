    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="relative bg-[#0f1016]/90 border border-white/10 rounded-2xl w-full max-w-md shadow-2xl p-6 backdrop-blur-xl">
        ...
        <p className="text-slate-400 text-sm mb-6 leading-relaxed">
          Are you sure you want to delete <span className="text-white font-medium">{project.name}</span>? This action cannot be undone and will remove all associated documents and data.
        </p>
